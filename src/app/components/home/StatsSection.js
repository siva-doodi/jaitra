...
export default function StatsSection() {
  ...
  return (
    <section className="relative w-full py-20 px-6 md:px-12 lg:px-24 overflow-hidden bg-[#F9F3FA]">
  <div className="absolute -top-16 -left-16 w-40 h-40 bg-[#FBEDED] rounded-full opacity-30 animate-bounce"></div>
  <div className="absolute -bottom-20 -right-20 w-56 h-56 bg-[#F7EBF0] rounded-full opacity-30 animate-pulse"></div>
