export default function AnimationSection() {
  return (
  <section className="relative w-full bg-[#F9F3FA] py-24 px-6 md:px-12 lg:px-24 overflow-hidden">
  <div className="absolute -top-24 -left-24 w-80 h-80 bg-[#FBEDED] rounded-full opacity-30 animate-bounce"></div>
  <div className="absolute -bottom-32 -right-32 w-96 h-96 bg-[#F7EBF0] rounded-full opacity-30 animate-spin-slow"></div>
  <div className="absolute top-1/3 left-1/2 w-24 h-24 bg-[#E0F2FE] rounded-full opacity-20 animate-ping"></div>
